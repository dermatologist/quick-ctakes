...
public class CtakesResource {
    ...
    public void init() {
        // writeResources();
        _pipelineRunners.put(DEFAULT_PIPELINE, new PipelineRunner(
                "/home/bell/Documents/work/quick-ctakes/src/main/resources/META-INF/resources/Default.piper"));
    }

    /**
     * The pipeline (Default.piper) file and the init method above require the
     * full/relative path. Accessing the path inside the container is tricky. Hence
     * the resources are written to the /config folder and read from there.
     */
